...
public class GenerateSurvivalGraphOld extends Problem {
	 ...
	 * @param rEng R Engine
	 */
	public GenerateSurvivalGraphOld(String solutionType, Integer numberOfBits, String dataFileName, String testDataFile, Rengine rEng) {
